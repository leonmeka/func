...
import { useZoom } from "@func/hooks/use-zoom";
import { useResize } from "@func/hooks/use-resize";
import { usePan } from "@func/hooks/use-pan";
import { useMouse } from "@func/hooks/use-mouse";

import { Range, Theme as ThemeType } from "@func/types";
